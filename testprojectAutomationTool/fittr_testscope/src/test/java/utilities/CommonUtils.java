...
public class CommonUtils {
	...
	public static AndroidDriver getDriver() throws IOException, AgentConnectException, InvalidTokenException, ObsoleteVersionException {
		
		serverUrl=new URL("http://0.0.0.0:"+APPIUM_PORT_NUMBER+"/wd/hub");
		driver = new AndroidDriver(capabilities,"Examples","zmIUIf7il0_cibX2NHQQdDEzyUO1xIBxH-7NscagQ6s1");
